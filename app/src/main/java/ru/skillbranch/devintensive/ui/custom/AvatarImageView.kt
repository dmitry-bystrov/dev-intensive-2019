...
class AvatarImageView @JvmOverloads constructor(
    ...
    init {
        ...
        attrs?.let {
            val arr = context.obtainStyledAttributes(it, R.styleable.AvatarImageView)
            borderColor = arr.getColor(R.styleable.AvatarImageView_aiv_borderColor, DEFAULT_BORDER_COLOR)
            borderWidth = arr.getDimension(R.styleable.AvatarImageView_aiv_borderWidth, defBorderWidth)
            arr.recycle()
        }
